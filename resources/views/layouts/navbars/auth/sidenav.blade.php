<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'quotation') == true ? 'active' : '' }}" href="{{ route('quotation.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'purchase-order') == true ? 'active' : '' }}" href="{{ route('po.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'delivery-order') == true ? 'active' : '' }}" href="{{ route('do.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <svg fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 512 512" xml:space="preserve">
                        <g>
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'invoice') == true ? 'active' : '' }}" href="{{ route('invoice.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            @endif
            {{-- @if(Auth::user()->hasAnyPermission(['master-terms'])) --}}
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'master-terms') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'master-terms/index']) }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <svg fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            viewBox="0 0 512 512" xml:space="preserve">
                            <g>
                    ...
                    <span class="nav-link-text ms-1">Master Term</span>
                </a>
            </li>
            {{-- @endif --}}
